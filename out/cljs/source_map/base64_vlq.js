...
var digit_27552 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_27553__$1 = (vlq >>> cljs.source_map.base64_vlq.vlq_base_shift);
while(true){
if((vlq_27553__$1 > (0))){
var digit_27554__$1 = (digit_27552 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode.call(null,digit_27554__$1));

var G__27555 = (vlq_27553__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__27556 = (vlq_27553__$1 >>> cljs.source_map.base64_vlq.vlq_base_shift);
digit_27552 = G__27555;
vlq_27553__$1 = G__27556;
continue;
} else {
sb.append(cljs.source_map.base64.encode.call(null,digit_27552));
}
break;
}
...
var G__27557 = i__$1;
var G__27558 = result__$1;
var G__27559 = shift__$1;
i = G__27557;
result = G__27558;
shift = G__27559;
continue;
